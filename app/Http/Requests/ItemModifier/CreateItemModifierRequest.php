...
class CreateItemModifierRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'title' => 'required|string|max:100|unique:item_modifiers,title',
    ...
    public function process($req){
        try {
            $item_modifier = new ItemModifier();
            ...
            return ['success' => true, 'item_modifiers' => $item_modifiers, 'msg' => 'Item modifier has been created successfully'];
