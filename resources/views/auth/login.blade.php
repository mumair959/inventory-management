...
<div class="card p-2">
    ...
    <div class="app-brand justify-content-center mt-5">
        ...
        <span class="app-brand-text demo text-heading fw-bold">Restaurant ERP</span>
        </a>
    </div>
    <!-- /Logo -->

    <div class="card-body mt-2">
        <h4 class="mb-2">Welcome to Restaurant ERP! 👋</h4>
        <p class="mb-4">Please sign-in to your account and start the adventure</p>

        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">
        @csrf
        <div class="form-floating form-floating-outline mb-3">
            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Enter email address" autofocus required>
