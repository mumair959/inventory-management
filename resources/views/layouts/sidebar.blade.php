...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo ">
        <a href="{{route('dashboard')}}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">Restaurant ERP</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons mdi mdi-archive-check-outline"></i>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{route('item_modifiers')}}" class="menu-link">
                        <div data-i18n="Item Modifiers">Item Modifiers</div>
                    </a>
                </li>   
                <li class="menu-item">
                    <a href="{{route('item_variations')}}" class="menu-link">
                        <div data-i18n="Item Variations">Item Variations</div>
                    </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="{{route('units')}}" class="menu-link">
                        <div data-i18n="Item Units">Item Units</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            <a href="{{route('recipes')}}" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-note-edit-outline"></i>
